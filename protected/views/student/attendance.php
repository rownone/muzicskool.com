...
?>
<style>
    tr.odd td:nth-child(6), tr.even td:nth-child(6),tfoot tr td:nth-child(6){
        text-align:center;
    }
</style>
...
$scheduleColumns = array(
    array(
        'name'=>'date_schedule',
        'value'=>'date("M j, Y", strtotime($data->date_schedule))',
    ),
    array(
        'name'=>'teacher_id',
    ...
    array(
        ...
        'name'=>'id',
        'type'=>'raw',
        'value'=>array($classSchedule,'getAttendanceSymbol'),
    ),
    array(
        'header'=>'Notes',
        'name'=>'notes',
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'summaryText'=>'',
    //'summaryText'=>($classSchedule===null)?"":"<b>Name: </b>".$classSchedule->enrollment->student->name." <b>Course:</b>".$classSchedule->enrollment->course->name,
    //'summaryText'=>($classSchedule===null)?"1":$classSchedule->enrollment->id,
));?>
</div>
