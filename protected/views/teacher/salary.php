...
<style>
    #salary-grid tr.odd td:nth-child(3), #salary-grid tr.even td:nth-child(3), #salary-grid tfoot tr td:nth-child(3){
        text-align:right;
    }
</style>
<?php
...
?>
<h1 id="title">Teacher Salary</h1><br>
...
<input type="button" value="Browse Teacher" id="browse-teacher" name="browse-teacher">
...
$this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'salary-grid',
    'dataProvider'=>$model->searchTeacherSalary($date1,$date2),
    'cssFile' => Yii::app()->baseUrl . '/css/grid.css',
	'columns'=>array(
        array(
           'name'=>'teacher_replacement_id',
           'header'=>'Name',
           'type'=>'raw',
           'value'=>'$data->teacher_replacement->name',
           'footer'=>'<b>Total:</b>'
        ),
        array(
            'name'=>'teacher_replacement_id',
            ...
            'type'=>'raw',
            'value'=>'$data->class_session',
            'footer'=>$model->searchTeacherSalary($date1,$date2)===0 ? '' : "<b>".$model->classSessionTotal($model->searchTeacherSalary($date1,$date2))."</b>"
        ),
        array(
            'name'=>'teacher_salary',
            'header'=>'Salary',
            ...
            'footer'=>$model->searchTeacherSalary($date1,$date2)===0 ? '' : "<b>".$model->salaryTotal($model->searchTeacherSalary($date1,$date2))."</b>"
        ),        
        /*array(
                'class'=>'CButtonColumn',
            ...
            'buttons'=>array
            (
                'view' => array('url'=>'Yii::app()->createUrl("/teacher/salaryDetails", 
                    array("teacher_id" => $data->teacher_replacement_id,
...
<?php $this->renderPartial('_browse',array('teacher'=>$teacher,'date1'=>$date1,'date2'=>$date2)); ?>
