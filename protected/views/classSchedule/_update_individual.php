...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="row">
        ...
        <?php echo $form->dropDownList($model,'teacher_attended',array('0'=>'No','1'=>'Yes')
                ,array('options' => array($model->teacher_attended=>array('selected'=>true)))); ?>
    ...
    <div id="div-teacher-replace" class="row" <?php echo $display;?>>
        ...
        <input type="text" disabled value="<?php echo $teacher_replacement;?>" id="ClassSchedule_teacher_replacement" maxlength="60" size="60">
