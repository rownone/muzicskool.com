...
class ContactController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete','saveStudent'),
				'users'=>array('@'),
			),
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('assessment','viewLead'),
				'users'=>array('@'),
			),
    ...
    public function actionSaveStudent($id)
	{
        ...
        if($model===null)
            ...
            $student = new Student();
            $student->first_name = $fistname;
            $student->last_name = $lastname;
            $student->middle_name = $middlename;
            $student->name = $model->name;
            $student->contact_number = $model->contact_number;
            $student->home_address = $model->address;
            $student->email = $model->email;
            if($student->save(false)){
                $this->redirect(array('student/update','id'=>$student->id));
            }else{
